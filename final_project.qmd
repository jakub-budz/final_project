...
chicago = pd.read_csv('CommAreas_20241127.csv')
...
plt.savefig("com_crime_total.png", bbox_inches='tight', dpi=300)
plt.close()
```
...
plt.savefig("vrs_com_crime_total.png", bbox_inches='tight', dpi=300)
plt.close()
```
...
plt.savefig("com_crime_total_15_19.png", bbox_inches='tight', dpi=300)
plt.close()
```
...
plt.savefig("com_crime_total_20_24.png", bbox_inches='tight', dpi=300)
plt.close()
```
...
plt.savefig("com_crime_diff.png", bbox_inches='tight', dpi=300)
plt.close()
```
...
plt.savefig("vrs_com_crime_diff.png", bbox_inches='tight', dpi=300)
plt.close()
```